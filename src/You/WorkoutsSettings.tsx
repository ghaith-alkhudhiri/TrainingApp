...
export class WorkoutsSettings extends Component<Props, State> {
  ...
  render() {
    ...
    const tabs = [
        {
          ...
          label: 'Ongoing',
          content: (
            <View style={{gap: 22, paddingHorizontal: 24}}>
              <FlatList
    ...
    return (
      <ScreenWrapper childrenContainerStyle={{padding: 0, gap: 0}} title='My Workouts'>
