...
function SeatsIcon(props) {
  return (
    ...
    >
      ...
      />
      <Path
        d="M20.873 13.735a.509.509 0 01.726.502l-.359 3.954c-.21 2-1.03 4.04-5.43 4.04H8.19c-4.4 0-5.22-2.04-5.43-4.03l-.34-3.748a.508.508 0 01.715-.506c1.14.516 3.242 1.43 4.542 1.77a.57.57 0 01.369.315c.607 1.298 1.923 1.989 3.824 1.989 1.882 0 3.215-.718 3.824-2.019a.571.571 0 01.37-.315c1.38-.363 3.618-1.385 4.81-1.952z"
        fill="#0165FC"
      />
    </Svg>
  )
