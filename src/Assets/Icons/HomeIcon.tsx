      ...
      <View style={{ width: 25, height: 24 }}>
        {!this.props.focused ?
          <Svg width="100%" height="100%" viewBox="0 0 25 24" fill="none">
            <Path d="M12.5 18V15" stroke="#9DB2CE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <Path d="M10.57 2.81985L3.64002 8.36985C2.86002 8.98985 2.36002 10.2998 2.53002 11.2798L3.86002 19.2398C4.10002 20.6598 5.46002 21.8098 6.90002 21.8098H18.1C19.53 21.8098 20.9 20.6498 21.14 19.2398L22.47 11.2798C22.63 10.2998 22.13 8.98985 21.36 8.36985L14.43 2.82985C13.36 1.96985 11.63 1.96985 10.57 2.81985Z" stroke="#9DB2CE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          </Svg>
          :
          <Svg width="100%" height="100%" viewBox="0 0 25 24" fill="none">
